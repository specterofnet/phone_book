...
var CONTRACT_NAME = "dev-1630166597370-38868968426063" || 'chenbalder.testnet';
/* TODO: fill this in! */
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/jll", "/.near/validator_key.json"),
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("enter connect"); // Initializing connection to the NEAR node.
...
function save() {
  ...
  contract.addPhone({
    text: inpVal
  }, BOATLOAD_OF_GAS, (0, _big.default)(SUGGESTED_DONATION || '0').times(Math.pow(10, 24)).toFixed()).then(updateUI());
}
...
function updateUI() {
  ...
  if (!window.walletAccount.getAccountId()) {
    ...
    contract.getAllPhone().then(function (messages) {
...
function setHTML(arr) {
  ...
  arr.forEach(function (el, index) {
    ...
    html += "<p>".concat(index + 1, ":").concat(el.text, " </p>");
    html += "<p>".concat(el.sender, "</p>");
    html += "</div>";
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"config.js","big.js":"../node_modules/big.js/big.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
